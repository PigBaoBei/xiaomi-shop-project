...
<div class="container" style="background-color: white;">
	 					...
	 					<th width="100px">
		 					<div class="input-group">
		 						<span class="input-group-btn">
		 							<button class="btn btn-default" type="button" onclick="sub(${c.cid},${c.num},${c.goods.price})">-</button>
		 						</span>
		 						<input type="text" class="form-control" id="num_count${i.count}" value="${c.num}" readonly="readonly" style="width:40px">
		 						<span class="input-group-btn">
		 							<button class="btn btn-default" type="button" onclick="add(${c.cid},${c.num},${c.goods.price})">+</button>
		 						</span>
	 						</div>
	 					</th>
	 					<th>¥&nbsp;${c.money }</th>
	...
	<div class="row">
		<div class="pull-right" style="margin-right: 40px;">
	            ...
	            <div>
	            	<a id="removeAllProduct" href="javascript:void(0)"   onclick="clearCart(${userNow.id})" class="btn btn-default btn-lg">清空购物车</a>
	            	&nbsp;&nbsp;
	            	<a href="${pageContext.request.contextPath}/order?method=show&uid=${userNow.id}" class="btn  btn-danger btn-lg">去结算</a>
