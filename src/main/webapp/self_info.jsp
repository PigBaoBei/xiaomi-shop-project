...
<script type="text/javascript">
	...
	function deleteAddr(id)
	{
		if (confirm("是否要删除地址？"))
		{
			location.href = "address?method=delete&id="+id;
		}
	}

	function defaultAddr(id) {
		location.href = "address?method=setDefault&id="+id;
	}
...
<div id="dingdanxiangqing_body">
    <div id="dingdanxiangqing_body_big">
        <div id="big_left">
               ...
               <a id="big_left_a" href="${pageContext.request.contextPath}/order?method=show">我的订单</a><br/>
							...
							<div class="modal fade" tabindex="-1" role="dialog" id="myModal${address.id}">
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
									...
									<form action="address?method=update&id=${address.id}" method="post" class="form-horizontal">
