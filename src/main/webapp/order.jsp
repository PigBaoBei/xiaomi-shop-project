...
<head>
	...
	<script type="text/javascript">
		function createOrder(uid,sum){
			//选中地址的id
			location.href = "order?method=create&uid="+uid+"&money="+sum+"&aid="+$("#address").val();
		}
	</script>
</head>
...
<div class="container" style="background-color: white;">
	...
	<div class="row pull-right" style="margin-right: 40px;">
		<div style="margin-bottom: 20px;">
			<button  id="btn_add"  onclick="createOrder(${userNow.id},${sum})" class="btn  btn-danger btn-lg" type="button">提交订单</button>
		</div>
	</div>
</div>
