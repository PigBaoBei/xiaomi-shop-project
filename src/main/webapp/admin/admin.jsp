					...
					<ul id="sub1" class="nav collapse panel-collapse">
						...
						<li>
							<a href="#" id="invalid"><!-- 无效会员 -->
								<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp<b>无效会员管理</b>
							</a>
						</li>
					</ul>
				</li>
...
<%--						${pageContext.request.contextPath}/manageGoods?method=show--%>
						<li>
							<a href="#" id="showGoods" >
		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","/manageGoodsType?method=show");
				})
				$("#addGoodsType").click(function(){
					$(".dv_content").attr("src","manageGoodsType?method=add");
				})
				$("#showGoods").click(function(){
					// $(".dv_content").attr("src","admin/showGoods.jsp");
					$(".dv_content").attr("src","/manageGoods?method=show");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","admin/addGoods.jsp");
				})
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","/manageOrder?method=show");
				})
			</script>
