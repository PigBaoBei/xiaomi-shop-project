...
<div style="margin: 0 auto;width: 90%;">
	<ol class="breadcrumb">
		<li><a href="#">小米商城</a></li>
		<li><a href="#">手机</a></li>
		<li class="active"><a href="getGoodsListByTypeId?typeid=${goods.tid}">手机</a></li>
	</ol>
</div>
			...
			<div class="panel panel-default" style="height: 560px">
				...
				<div class="panel-body">
					...
					<div style="margin-left: 10px;">
						...
						<p>详细介绍:</p>
						<p>&nbsp;&nbsp;${goods.intro }</p>
						<a href="${pageContext.request.contextPath}/cart?method=create&pid=${goods.id}" class="btn btn-warning">加入购物车&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-shopping-cart"></span></a>&nbsp;&nbsp;&nbsp;
