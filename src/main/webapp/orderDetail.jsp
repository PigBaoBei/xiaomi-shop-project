	...
	<div class="panel-body">
		<table cellpadding="0" cellspacing="0" align="center" width="100%" class="table table-striped table-bordered table-hover">
			...
			<tr>
				...
				<td>${order.id}</td>
				<td>订单时间:</td>
				<td><fmt:formatDate value="${order.time}" pattern="yyyy年MM月dd日" /> </td>
			</tr>
			<tr>
				<td>收件人:</td>
			...
			<tr>
				...
				<td colspan="3">
					<table align="center" cellpadding="0" cellspacing="0" width="100%"  class="table table-striped table-bordered table-hover">
						...
						<c:forEach items="${order.orderDetails}" var="item" varStatus="i">
							<tr align="center">
								<th>${i.count}</th>
								<th>
									<img src="${pageContext.request.contextPath}/${item.goods.picture}" width="50px" height="50px">
								</th>
