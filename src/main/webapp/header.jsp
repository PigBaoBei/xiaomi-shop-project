            ...
            $.ajax({
                ...
                success:function(res){
                    for(var i in res['data']){
                        // 动态插入一个元素
                        var a = $("<a href='${pageContext.request.contextPath}/goods?method=show&tid="+res.data[i].id+"'>"+res.data[i].name+"</a>");
                        $("#goodsType").append(a);
...
<div id="top">
    <div id="topdiv">
        ...
        <span style="float:right">
                ...
                <li>|</li>
                <a href="${pageContext.request.contextPath}/admin/login.jsp" id="a_top">管理员登陆</a>
                <a href="${pageContext.request.contextPath}/cart?method=show&uid=${userNow.id}" id="shorpcar">购物车</a>
            </span>
    </div>
</div>
<div id="second">
